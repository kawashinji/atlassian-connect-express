...
const HostClientConnectOnForge = require("./host-request-connect-on-forge");
...
class HostClient {
  ...
  /**
   * Convert HostRequest into HostClient, which is using the jwt auth
   *
   * @returns HostClient - `hostClient` object suitable for chaining
   */
  usingJwt() {
  ...
  /**
   * Convert HostRequest into HostClientConnectOnForge, which is using the oauth2
   *
   * @returns HostClientConnectOnForge - `HostClientConnectOnForge` object suitable for chaining
   */
  usingOAuth2() {
    const client = new HostClientConnectOnForge(
      this.addon,
      this.context,
      this.clientKey
    );
